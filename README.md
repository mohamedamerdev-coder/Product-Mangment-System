...
* **✏️ Update Mode:** Smoothly retrieve data back to inputs for editing without refreshing the page.
* **🗑️ Delete:** Options to delete a single item or **Delete All** items at once with one click.
